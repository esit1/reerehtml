...
class partial_Forms_Fields_Float_Default_fd067e935e404890b8550121e997530e67743032 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<input type="hidden" name="tx_mask_tools_maskmask[dummy][--index--][int]" value="double2"
			 class="tx_mask_fieldcontent_eval"/>
<input type="hidden" name="tx_mask_tools_maskmask[storage][tca][--index--][config][eval]" value="double2"
