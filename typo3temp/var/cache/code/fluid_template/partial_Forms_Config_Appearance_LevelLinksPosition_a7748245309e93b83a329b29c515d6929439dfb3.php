...
class partial_Forms_Config_Appearance_LevelLinksPosition_a7748245309e93b83a329b29c515d6929439dfb3 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1['key'] = 'tx_mask.field.inline.level_links_position';
...
<div class="t3js-formengine-field-item">
	<div class="form-control-wrap" style="">
		<select name="tx_mask_tools_maskmask[storage][tca][--index--][config][appearance][levelLinksPosition]"
						class="form-control" title="levelLinksPosition">
			<option ';
...
$array5 = array();
$array6 = array (
);$array5['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.appearance.levelLinksPosition', $array6)]);
$array5['1'] = ' == \'top\'';

$expression7 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'top');};
...
$arguments8['key'] = 'tx_mask.field.inline.level_links_position.top';
...
$array12 = array();
$array13 = array (
);$array12['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.appearance.levelLinksPosition', $array13)]);
$array12['1'] = ' == \'bottom\'';

$expression14 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'bottom');};
...
$arguments15['key'] = 'tx_mask.field.inline.level_links_position.bottom';
...
$array19 = array();
$array20 = array (
);$array19['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.appearance.levelLinksPosition', $array20)]);
$array19['1'] = ' == \'both\'';

$expression21 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'both');};
...
$arguments22['key'] = 'tx_mask.field.inline.level_links_position.both';
...
$array26 = array();
$array27 = array (
);$array26['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.appearance.levelLinksPosition', $array27)]);
$array26['1'] = ' == \'none\'';

$expression28 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'none');};
...
$arguments29['key'] = 'tx_mask.field.inline.level_links_position.none';
