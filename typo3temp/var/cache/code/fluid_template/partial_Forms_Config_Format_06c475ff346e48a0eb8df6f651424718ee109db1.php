...
class partial_Forms_Config_Format_06c475ff346e48a0eb8df6f651424718ee109db1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments1['key'] = 'tx_mask.field.text.format';
...
<div class="t3js-formengine-field-item">
	<div class="form-control-wrap" style="">
		<select name="tx_mask_tools_maskmask[storage][tca][--index--][config][format]" class="form-control" title="format">
			<option ';
...
$array5 = array();
$array6 = array (
);$array5['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array6)]);
$array5['1'] = ' == \'\'';
...
$arguments8['key'] = 'tx_mask.field.text.format.none';
...
$array12 = array();
$array13 = array (
);$array12['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array13)]);
$array12['1'] = ' == \'html\'';

$expression14 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'html');};
...
$arguments10['then'] = 'selected=selected';
...
$arguments15['key'] = 'tx_mask.field.text.format.html';
...
$array19 = array();
$array20 = array (
);$array19['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array20)]);
$array19['1'] = ' == \'typoscript\'';

$expression21 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'typoscript');};
...
$arguments22['key'] = 'tx_mask.field.text.format.typoscript';
...
$array26 = array();
$array27 = array (
);$array26['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array27)]);
$array26['1'] = ' == \'javascript\'';

$expression28 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'javascript');};
...
$arguments29['key'] = 'tx_mask.field.text.format.javascript';
...
$array33 = array();
$array34 = array (
);$array33['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array34)]);
$array33['1'] = ' == \'css\'';

$expression35 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'css');};
...
$arguments31['then'] = 'selected=selected';
...
$arguments36['key'] = 'tx_mask.field.text.format.css';
...
$array40 = array();
$array41 = array (
);$array40['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array41)]);
$array40['1'] = ' == \'xml\'';

$expression42 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'xml');};
...
$arguments38['then'] = 'selected=selected';
...
$arguments43['key'] = 'tx_mask.field.text.format.xml';
...
$array47 = array();
$array48 = array (
);$array47['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array48)]);
$array47['1'] = ' == \'php\'';

$expression49 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'php');};
...
$arguments45['then'] = 'selected=selected';
...
$arguments50['key'] = 'tx_mask.field.text.format.php';
...
$array54 = array();
$array55 = array (
);$array54['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array55)]);
$array54['1'] = ' == \'sparql\'';

$expression56 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'sparql');};
...
$arguments52['then'] = 'selected=selected';

$output0 .= TYPO3Fluid\Fluid\ViewHelpers\IfViewHelper::renderStatic($arguments52, $renderChildrenClosure53, $renderingContext);

$output0 .= ' value="sparql">
			';
// Rendering ViewHelper TYPO3\CMS\Fluid\ViewHelpers\TranslateViewHelper
...
$arguments57['key'] = 'tx_mask.field.text.format.sparql';
...
$array61 = array();
$array62 = array (
);$array61['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.format', $array62)]);
$array61['1'] = ' == \'mixed\'';

$expression63 = function($context) {return (TYPO3Fluid\Fluid\Core\Parser\BooleanParser::convertNodeToBoolean($context["node0"]) == 'mixed');};
...
$arguments59['then'] = 'selected=selected';
...
$arguments64['key'] = 'tx_mask.field.text.format.mixed';
