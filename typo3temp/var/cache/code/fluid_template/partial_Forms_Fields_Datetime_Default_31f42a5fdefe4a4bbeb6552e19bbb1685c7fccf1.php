...
class partial_Forms_Fields_Datetime_Default_31f42a5fdefe4a4bbeb6552e19bbb1685c7fccf1 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$output0 .= '][--index--]" value="datetime"/>
<input type="hidden" name="tx_mask_tools_maskmask[dummy][--index--][datetime]" value="datetime"
			 class="tx_mask_fieldcontent_eval"/>
<input type="hidden" name="tx_mask_tools_maskmask[storage][tca][--index--][config][eval]" value="datetime"
