...
class Standard_action_3boxenmitbild_f7efb6dc354235d522889fa1ea07bbf147eec46e extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments7['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_bildbox1';
...
$arguments17['key'] = 'LLL:EXT:lang/locallang_tca.xlf:sys_file_reference.uid_local';
...
$output16 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.table', $array19)]);

$output16 .= '|';
$array20 = array (
);
$output16 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.uid', $array20)]);

$output16 .= '|';
$array21 = array (
);
$output16 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.title', $array21)]);

$output16 .= ' (id=';
$array22 = array (
);
$output16 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.uid', $array22)]);
...
$array15 = array (
);$arguments13['each'] = $renderingContext->getVariableProvider()->getByPath('item.uid_local', $array15);
$arguments13['as'] = 'file';
...
$array11 = array (
);$arguments9['each'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_bildbox1', $array11);
$arguments9['as'] = 'item';
...
$array3 = array();
$array4 = array (
);$array3['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_bildbox1', $array4);
...
$arguments29['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_textbox1';
...
$output28 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_textbox1', $array31)]);

$output28 .= ' (raw=';
$array32 = array (
);
$output28 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('row.tx_dreiboxv1_textbox1', $array32)]);
...
$array25 = array();
$array26 = array (
);$array25['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_textbox1', $array26);
...
$arguments39['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_linkbox1';
...
$output38 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_linkbox1', $array41)]);

$output38 .= ' (raw=';
$array42 = array (
);
$output38 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('row.tx_dreiboxv1_linkbox1', $array42)]);
...
$array35 = array();
$array36 = array (
);$array35['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_linkbox1', $array36);
...
$arguments49['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_bildbox2';
...
$arguments59['key'] = 'LLL:EXT:lang/locallang_tca.xlf:sys_file_reference.uid_local';
...
$output58 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.table', $array61)]);

$output58 .= '|';
$array62 = array (
);
$output58 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.uid', $array62)]);

$output58 .= '|';
$array63 = array (
);
$output58 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.title', $array63)]);

$output58 .= ' (id=';
$array64 = array (
);
$output58 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.uid', $array64)]);
...
$array57 = array (
);$arguments55['each'] = $renderingContext->getVariableProvider()->getByPath('item.uid_local', $array57);
$arguments55['as'] = 'file';
...
$array53 = array (
);$arguments51['each'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_bildbox2', $array53);
$arguments51['as'] = 'item';
...
$array45 = array();
$array46 = array (
);$array45['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_bildbox2', $array46);
...
$arguments71['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_textbox2';
...
$output70 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_textbox2', $array73)]);

$output70 .= ' (raw=';
$array74 = array (
);
$output70 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('row.tx_dreiboxv1_textbox2', $array74)]);
...
$array67 = array();
$array68 = array (
);$array67['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_textbox2', $array68);
...
$arguments81['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_linkbox2';
...
$output80 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_linkbox2', $array83)]);

$output80 .= ' (raw=';
$array84 = array (
);
$output80 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('row.tx_dreiboxv1_linkbox2', $array84)]);
...
$array77 = array();
$array78 = array (
);$array77['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_linkbox2', $array78);
...
$arguments91['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_bildbox3';
...
$arguments101['key'] = 'LLL:EXT:lang/locallang_tca.xlf:sys_file_reference.uid_local';
...
$output100 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.table', $array103)]);

$output100 .= '|';
$array104 = array (
);
$output100 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.uid', $array104)]);

$output100 .= '|';
$array105 = array (
);
$output100 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('file.title', $array105)]);

$output100 .= ' (id=';
$array106 = array (
);
$output100 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('item.uid', $array106)]);
...
$array99 = array (
);$arguments97['each'] = $renderingContext->getVariableProvider()->getByPath('item.uid_local', $array99);
$arguments97['as'] = 'file';
...
$array95 = array (
);$arguments93['each'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_bildbox3', $array95);
$arguments93['as'] = 'item';

$output90 .= TYPO3Fluid\Fluid\ViewHelpers\ForViewHelper::renderStatic($arguments93, $renderChildrenClosure94, $renderingContext);
...
$array87 = array();
$array88 = array (
);$array87['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_bildbox3', $array88);
...
$arguments113['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_textbox3';
...
$output112 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_textbox3', $array115)]);

$output112 .= ' (raw=';
$array116 = array (
);
$output112 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('row.tx_dreiboxv1_textbox3', $array116)]);
...
$array109 = array();
$array110 = array (
);$array109['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_textbox3', $array110);
...
$arguments123['key'] = 'LLL:EXT:dreibox_v1/Resources/Private/Language/locallang_db.xlf:tt_content.tx_dreiboxv1_linkbox3';
...
$output122 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_linkbox3', $array125)]);

$output122 .= ' (raw=';
$array126 = array (
);
$output122 .= call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('row.tx_dreiboxv1_linkbox3', $array126)]);
...
$array119 = array();
$array120 = array (
);$array119['0'] = $renderingContext->getVariableProvider()->getByPath('processedRow.tx_dreiboxv1_linkbox3', $array120);
