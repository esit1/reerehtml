...
class partial_Forms_Config_Autocomplete_1c8519e5acb836d0975c9b004a6b71b8347cf431 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<div class="t3js-formengine-field-item check-item">
	<div class="form-control-wrap" style="">
		<input name="tx_mask_tools_maskmask[storage][tca][--index--][config][autocomplete]" type="checkbox" ';
...
$array3 = array();
$array4 = array (
);$array3['0'] = call_user_func_array( function ($var) { return (is_string($var) || (is_object($var) && method_exists($var, '__toString')) ? htmlspecialchars((string) $var, ENT_QUOTES) : $var); }, [$renderingContext->getVariableProvider()->getByPath('field.config.autocomplete', $array4)]);
$array3['1'] = ' == \'1\'';
...
$output0 .= ' value="1" title="autocomplete" />
	</div>
</div>
...
$arguments6['key'] = 'tx_mask.field.string.autocomplete';
