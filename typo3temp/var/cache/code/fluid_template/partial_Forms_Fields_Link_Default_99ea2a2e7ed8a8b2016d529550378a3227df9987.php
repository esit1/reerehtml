...
class partial_Forms_Fields_Link_Default_99ea2a2e7ed8a8b2016d529550378a3227df9987 extends \TYPO3Fluid\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
<input type="hidden"
			 name="tx_mask_tools_maskmask[storage][tca][--index--][config][fieldControl][linkPopup][options][title]"
			 value="Link"/>
<input type="hidden" name="tx_mask_tools_maskmask[storage][tca][--index--][config][wizards][link][icon]"
			 value="actions-wizard-link"/>
<input type="hidden"
			 name="tx_mask_tools_maskmask[storage][tca][--index--][config][fieldControl][linkPopup][options][windowOpenParameters]"
			 class="tx_mask_fieldcontent_jsopenparams_result" value="height=300,width=500,status=0,menubar=0,scrollbars=1"/>
<input type="hidden" name="tx_mask_tools_maskmask[storage][tca][--index--][config][eval]" value=""
			 class="tx_mask_fieldcontent_evalresult"/>
<input type="hidden"
			 name="tx_mask_tools_maskmask[storage][tca][--index--][config][fieldControl][linkPopup][options][blindLinkOptions]"
			 value="folder" class="tx_mask_fieldcontent_linkresult"/>
